// FOR FUTURE USE WHEN I IMPLEMENT MORE THAN ONE WEEK ON THE BOARD
...
// const addNewWeek = async (req, res) => {
...
//     res.status(200).json({ status: 200, message: "new week added" });
//   } catch (err) {
//     console.log(err);
//   } finally {
//     await client.close();
